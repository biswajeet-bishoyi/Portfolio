...
export function CursorGrid({
  ...
  useEffect(() => {
    ...
    const rebuild = () => {
      const p = propsRef.current as Required<CursorGridProps>;
    ...
    // Use window listeners so it picks up events even if the component is behind pointer-events-none elements
